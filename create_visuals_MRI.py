...
if __name__ == '__main__':
    ...
    datasets = ["LIDC-IDRI", "LITS", "CTSpine1K"]
        ...
        for j in range(col):
            ...
            if (j == 0) and show_HR_as_large_img:
                ...
                if (j == 0):
                    ...
                    ax.imshow(img.transpose(1, 0, 2))
                    ax.text(0.5, -0.04, subplot_text[j], ha='center', va='top', fontsize=12, transform=ax.transAxes)
