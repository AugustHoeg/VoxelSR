...
if __name__ == '__main__':
    ...
    large_image_string = r"WOOD" # r"Registered"
    ...
    for i in range(row):
        for j in range(col):
            ...
            if j % 2 == 0:
                ...
                large_img_size = 512
                large_img_location = (960, 200)
                red_box_coords = (180, 0)
                red_box_size = 128
            ...
            if j % 2 == 0:
                ax.set_title(f"Sample excluded", fontsize=16, pad=0., y=1.03)
            else:
    ...
    save_path = f"../figures/{large_image_string}_ablation_samples_{img_idx}_{red_box_size}.pdf"
