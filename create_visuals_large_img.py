...
if __name__ == '__main__':
    ...
    large_img_size = 1920//2
    large_img_location = (500, 300)
    red_box_size = 256
    ...
    ax_full.set_xticks([])
    ax_full.set_yticks([])
    ax_full.text(0.5, -0.04, "HR region", ha='center', va='top', fontsize=16, transform=ax_full.transAxes)
    ...
    ax_zoom.set_xticks([])
    ax_zoom.set_yticks([])
    ax_zoom.text(0.5, -0.04, "LR region", ha='center', va='top', fontsize=16, transform=ax_zoom.transAxes)
