...
if __name__ == "__main__":
    ...
    shallow_feats = [128, 128, 128]  # 128 normally
    pre_up_feats = [64, 64]
    num_blks = [1, 2, 3]  # [1, 1, 3]  # [6, 6, 6]
    blk_layers = [6, 6, 6]  # Number of transformer layers per block in each level
    patch_sizes = [8, 4, 2]  # [16, 8, 2]
    ct_size = 2
    ct_pool_method = "conv"
    ct_embed_dims = [180, 180, 180]  # 128 normally. Old model: [512, 128, 64]  # [512, 128, 64]
    embed_dims = [180, 180, 180]  # 128 normally. Old model: [512, 128, 64]  # [512, 128, 64]
